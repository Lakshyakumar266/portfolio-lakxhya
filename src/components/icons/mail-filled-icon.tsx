...
export const MailFilledIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    return (
      <motion.svg
        ...
        className={`${className} cursor-pointer perspective-distant inline-flex items-center justify-center`}
        onHoverStart={start}
        onHoverEnd={stop}
